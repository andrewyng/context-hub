...
context-hub fork used as reference; iAiFy adds governance overlays.
...
- `ee0027d chore: sync CLAUDE.md and copilot-instructions docs`
- `b221f9b docs: add CLAUDE.md for iAiFy governance`
- `c53a956 ci: add dependabot.yml for iAiFy governance`
- `c5c5003 docs: add AGENTS.md for iAiFy governance`
- `e157608 docs: add copilot-instructions.md for iAiFy governance`
