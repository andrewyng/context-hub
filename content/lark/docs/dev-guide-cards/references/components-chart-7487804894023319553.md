...
Source URL: https://open.feishu.cn/document/feishu-cards/feishu-card-cardkit/components/chart
Updated: 2025-06-25
...
是否可在独立窗口查看 | 开启后：<br>-   PC 端：用户可点击图表组件右上角的 **独立窗口查看** 按钮，在独立飞书窗口查看<br><br><br>- 移动端：用户可点击图表，全屏查看
