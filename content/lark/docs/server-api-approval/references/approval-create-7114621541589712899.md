...
Source URL: https://open.feishu.cn/document/server-docs/approval-v4/approval/create
Updated: 2025-05-20
...
icon | int | 否 | 审批图标枚举，默认为 0。下图从左至右，从上到下依次为 0~24 号图标。<br><br>**示例值**：0<br>**默认值**：`0`
...
400 | 1390015 | approval is not active | 审批定义已停用，请确保当前所用的审批定义已启用后重试。你可以登录[飞书审批管理后台](https://www.feishu.cn/approval/admin/approvalList)，查看相应审批定义是否被停用。<br>
