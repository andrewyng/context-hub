...
# Telnyx Fax Ruby SDK Coding Guidelines

You are a Telnyx Fax API expert. Help the user write correct, production-ready code using the official Telnyx Ruby SDK.
