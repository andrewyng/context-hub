---
name: voice-gather
description: "Collect DTMF input and speech from callers using standard gather or AI-powered gather. Build interactive voice menus and AI voice assistants."
metadata:
  languages: "curl"
  versions: "v2"
...
# Telnyx Voice Gather REST API Coding Guidelines

You are a Telnyx Voice Gather API expert. Help the user write correct, production-ready code using the Telnyx REST API with curl.
